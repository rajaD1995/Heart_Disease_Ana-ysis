...
#Seperating numerical and categorical attributes in seperate lists.
k1=[]
k2=[]
...
#descrption of categorical attributes & Continuous numerical attributes
desc_cat = [
    r'''
...
def Home():   
    ...
    #statistical info of the numerical variable
    st.subheader('Statistical information only for Continuous numerical variables:')
    st.write(health[k1].describe())
    

def Descrption_of_Attributes():
    #Details of Continuous numerical variables.
    ...
    # Create "Select All" checkbox to access the explanation of categorical attributes
...
# # Option 1 for navigation: Select only one option.
# # Section Mapping Dictionary
# section_map = {
#     "Home": Home,
#     "Descrption of Attributes": Descrption_of_Attributes,
#     "Visualization": Visualization,
#     'Key Insights' : Key_Insights
# }

# # Sidebar Navigation with "Show All" Option as Default
# st.sidebar.title("Navigation")
# section = st.sidebar.radio(
#     "Go to Section",
#     ["Show All"] + list(section_map.keys()),  # Add "Show All" with dynamic sections
#     index=0  # Set "Show All" as the default option
# )

# # Show All Sections when "Show All" is Selected
# if section == "Show All":
#     for func in section_map.values():
#         func()

# # Show Individual Sections Dynamically
# elif section in section_map:
#     section_map[section]()  # Call the respective function dynamically


# Option 2 for navigation: multiselect option.
# Section Mapping Dictionary
section_map = {
    "Home": Home,
    "Descrption of Attributes": Descrption_of_Attributes,
...
# Vertical Checkboxes for Section Selection
...
selected_sections = []
if home_selected:
    selected_sections.append("Home")
if descr_selected:
    selected_sections.append("Descrption of Attributes")
if viz_selected:
    selected_sections.append("Visualization")
if insights_selected:
    selected_sections.append("Key Insights")

# Show Selected Sections
if selected_sections:
    for section in selected_sections:
        if section in section_map:
            section_map[section]()  # Dynamically call the corresponding function
else:
    st.warning("⚠️ No section selected. Please select at least one section to view content.")
